...
namespace MVC2Assignment.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            //if (a.AccountNumber ){ModelState.AddModelError("AccountNumber", "Account number cannot be negative");}
            //if (string.IsNullOrEmpty(a.Name)){ModelState.AddModelError("Name", "Accountname is required"); }
           // if ((a.CurrentBalance >= 1 && a.CurrentBalance < 500) ||a.CurrentBalance  {ModelState.AddModelError("CurrentBalance", "Minimum balance must be atleast 500");}
